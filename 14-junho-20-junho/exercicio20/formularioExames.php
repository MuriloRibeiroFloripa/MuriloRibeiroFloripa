...
<body>
    ...
    <?php 
    $exameNota = @$_POST['exameNota'];

      if ($exameNota >= 5) {   
        echo ("<br><br><center><table bgcolor=silver><tr><td><strong> MEDIA = $exameNota O aluno de exames foi APROVADO! </strong></td></tr></table></center>");
      }
      else {
        echo ("<br><br><center><table bgcolor=silver><tr><td><strong> MEDIA = $exameNota O aluno de exames foi REPROVADO! </strong></td></tr></table></center>");
      }
