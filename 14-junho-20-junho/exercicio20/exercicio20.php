...
<body>
  <nav>
      <ul>
        ...
        <p>Faça um programa para receber duas notas, calcular a média e apresentar se o aluno está aprovado ou reprovado. Considere que a média para aprovação seja 6 e caso a média seja menor que 2 o aluno estará reprovado. Outros casos o aluno estará em exame. Caso o aluno esteja em exame, solicite a nota e considere que a nota para aprovação de alunos em exame seja maior ou igual a 5.</p>
      </ul>         
  </nav>  
    <br>
