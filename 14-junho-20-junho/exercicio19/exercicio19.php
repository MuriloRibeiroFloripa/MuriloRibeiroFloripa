...
<body>
  <nav>
      <ul>
        ...
        <p>Faça um programa para receber duas notas, calcular a média e apresentar se o aluno está aprovado ou reprovado. Considere que a média para aprovação seja 6 e caso a média seja menor que 2 o aluno estará reprovado. Outros casos o aluno estará em exame.</p>
      </ul>         
  </nav>  
    <br>
