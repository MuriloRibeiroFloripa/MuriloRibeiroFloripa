...
<body>
  <nav>
      <ul>
        ...
        <center><p> Você escolheu Calcular Superfície do Retângulo!</p></center>
      </ul>
       </nav>
  <center>
   <form method="POST" action="retangulo.php">
      ...
      <table bgcolor="silver" width="18%" cellpadding="8">
        <tr>
          <td> <label><strong> Informe medida da base: </strong> </label> </td>
          <td><input type="text" name="base"></td>        
        </tr>
        <tr>
          <td><label> <strong>Informe medida da altura: </strong> </label></td>
   ...
   if($area != 0){    
   echo ("<br><br><center><table bgcolor=silver><tr><td><strong> Superficie do Retângulo = $area </strong></td></tr></table></center>");
    }
