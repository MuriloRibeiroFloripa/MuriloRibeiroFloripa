...
<body>
  <nav>
      <ul>
        ...
        <center><p> Você escolheu Calcular Superfície do Triângulo!</p></center>
      </ul>      
  </nav>
  <center>
   <form method="POST" action="triangulo.php">
      ...
      <table bgcolor="silver" width="18%" cellpadding="8">
        <tr>
          <td> <label><strong> Informe a Base: </strong> </label> </td>
          <td><input type="text" name="base"></td>        
        </tr>
        <tr>
          <td><label> <strong>Informe a Altura: </strong> </label></td>
   ...
   echo ("<br><br><center><table bgcolor=silver><tr><td><strong> Superficie do Triângulo = $area </strong></td></tr></table></center>");
    }
