...
<body>
    ...
    <ul>
        ...
        <p><b><h1>Exercicio 12:</h1> <br>  
    </ul>
    </nav>
    <?php 
    $dolar = @$_POST['dolar'];
    $dolarComercial = @$_POST['dolarComercial'];

    $cambio = ($dolar * $dolarComercial);

      if($cambio != 0){    
   echo ("<br><br><center><table bgcolor=silver><tr><td><strong>Total em Real = $cambio </strong></td></tr></table></center>");
    }
