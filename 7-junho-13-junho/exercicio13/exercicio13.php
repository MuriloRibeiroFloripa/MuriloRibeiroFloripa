...
<body>
  <nav>
      <ul>
        ...
        <p>Faça um programa para calcular a média de consumo de um veículo.</p>
      </ul>         
  </nav>  
    <br>
    <form method="post" action="consumo.php">
      <center>
        ...
        <tr>
            <td><label> Informe os KM rodados: </label></td>
            <td><input type="text" name="km"></td>        
        </tr>
        <tr>
            <td><label> Informe Combustivel Gasto: </label></td>
            <td><input type="text" name="combustivel"></td>        
        </tr>
        <tr> 
            <td></td>       
